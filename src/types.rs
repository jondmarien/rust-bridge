...
mod tests {
    ...
    fn test_analysis_result_success() {
        let metadata =
            AnalysisMetadata::new("test_plugin".to_string(), "/tmp/test.raw".to_string());

        let result: AnalysisResult<Vec<String>> =
            AnalysisResult::success(vec!["item1".to_string(), "item2".to_string()], metadata);
    ...
    fn test_analysis_result_failure() {
        ...
        let result: AnalysisResult<Vec<String>> =
            AnalysisResult::failure("Test error".to_string(), metadata);
    ...
    fn test_analysis_result_to_json() {
        ...
        let result: AnalysisResult<Vec<String>> =
            AnalysisResult::success(vec!["item1".to_string()], metadata);
